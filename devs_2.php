                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="font-weight-medium">
                            <div class="badge badge-warning">Available Soon</div>
                          </td>
                        </tr>
                        <?php endforeach; ?>
                      </tbody>
                    ...
                    <div class="col-12">
                      <nav aria-label="Page navigation example">
                        <ul class="pagination">
                          ...
                          <li class="page-item active"><a class="page-link" href="./devs_2.php">2</a></li>
                          <li class="page-item"><a class="page-link" href="./devs_3.php">3</a></li>
                          <li class="page-item"><a class="page-link" href="./devs_4.php">4</a></li>
                          <li class="page-item"><a class="page-link" href="./devs_3.php">Next</a></li>
                        </ul>
                      </nav>
                    </div>
                  </div>
