                    ...
                    <div class="col-12">
                      <nav aria-label="Page navigation example">
                        <ul class="pagination">
                          ...
                          <li class="page-item"><a class="page-link" href="companies_1.php">1</a></li>
                          <li class="page-item active"><a class="page-link" href="./companies_2.php">2</a></li>                         
